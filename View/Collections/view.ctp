...
<div id="pieces">
	<div class="pict-box">
		<a href="http://fistuline.local/images/2009page-19.jpg"><img class="pict-img" src="/images/2009page-19.jpg" /><span class="pict-cartel">Titre image</span></a>
	</div>
	<div class="pict-box">
		<a href="http://fistuline.local/images/2005page-07.JPG"><img class="pict-img" src="/images/2005page-07.JPG"/><span class="pict-cartel">Titre image</span></a>
	</div>
	<div class="pict-box">
		<a href="http://fistuline.local/images/moulures-proliferantes.jpg"><img class="pict-img" src="/images/moulures-proliferantes.jpg" /><span class="pict-cartel">Titre image</span></a>
	</div>
	<div class="pict-box">
        <a href="http://fistuline.local/images/sein-culbuto-2002.jpg"><img class="pict-img" src="/images/sein-culbuto-2002.jpg" /><span class="pict-cartel">Titre image</span></a>
    </div>
	<div class="pict-box">
    ...
    <div class="text-collection-box">
        ...
        Le recours au textile et aux travaux d’aiguille s’impose tout naturellement et corrobore le propos. Si la plasticienne s’inscrit ainsi dans une filiation 
        (la couture étant un loisir pratiqué tant par les hommes que par les femmes de sa famille), l’usage de techniques traditionnellement associées au beau sexe 
        faible lui permet d’approfondir son exploration de la féminité. Jadis, l’initiation précoce de la jeune fille aux travaux de couture et de tricot cachait 
        une leçon de maintien corporel et de docilité. Les instruments utiles à ces tâches (aiguilles et épingles) possèdent une puissante charge symbolique, 
        en ce que leur langage fut longtemps au cœur de l’éducation et de l’initiation sexuelle de la jeune fille, notamment au travers des contes. 
        Symbole phallique en psychanalyse freudienne, l’aiguille pique et transperce : elle marque le corps et fait perler le sang. Les marques rouges sur textile préparaient l’enfant, 
        puis la jeune fille, à l’art d’être une femme et à l’atteinte faite à sa chair : le fil rouge mis en œuvre dans la marquette (chef-d’œuvre au point de croix) 
